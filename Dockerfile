...
ADD https://github.com/gohugoio/hugo/releases/download/v0.48/hugo_0.48_Linux-64bit.tar.gz /tmp

RUN set -ex \
    && tar -xzvf /tmp/hugo_0.48_Linux-64bit.tar.gz -C /usr/local/bin/ \
    && rm -rf /tmp/hugo_0.48_Linux-64bit.tar.gz \
