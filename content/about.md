...
> Доступен номер журнала [2025 №2](/issue/2025-02/)
...
Рукописи статей направляются в редакцию *по рекомендациям* кафедр вузов или НТС отделов и должны сопровождаться *экспертными заключениями* о возможности опубликования, а также сопутствующими документами: *лицензионными договорами*, *актами приема-передачи* и *cогласиями на обработку персональных данных* для каждого автора (бланки лицензионного договора, акта приема-передачи и согласия размещены на сайте по адресу [https://nuclear-power-engineering.ru/docs/](https://nuclear-power-engineering.ru/docs/)).
...
В «электронном» варианте рукопись представляется файлом, подготовленным в текстовом процессоре MS Word, сопутствующие документы сканируются и файлы рукописи и «сканов» пересылаются в редакцию по электронной почте, подлинники сопутствующих документов затем направляются в редакцию почтой России.
